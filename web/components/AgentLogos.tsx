// Brand marks for the "Works with" agents grid, drawn as inline SVGs so the
// page stays self-contained. Anthropic and OpenAI use their official logomark
// paths; Cursor and Windsurf are close geometric recreations of their marks.
...
export function AnthropicLogo() {
  return (
    <svg width={SIZE} height={SIZE} viewBox="0 0 24 24" fill={INK} aria-label="Claude Code">
...
export function OpenAILogo() {
  return (
    <svg width={SIZE} height={SIZE} viewBox="0 0 24 24" fill={INK} aria-label="Codex">
